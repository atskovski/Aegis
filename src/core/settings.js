...
const DEFAULT_SETTINGS = Object.freeze({
  ...
  enterprise: {
    ...
    urlBlocklist: [],
    extensionAllowlist: [],
    blockUnlistedExtensions: false,
    disablePrinting: false,
    disableClipboardRead: true,
    disableScreenCapture: true,
    disableDeveloperTools: true,
    forceSiteIsolation: true
  },
  ...
  fireproofSites: [],
  customFilterRules: '',
  enabledFilterLists: ['ublock','ublock-privacy','ublock-unbreak','easylist','easyprivacy','pgl'],
  filterListAutoUpdate: true,
...
function sanitizeSettings(raw = {}) {
  ...
  return {
    ...
    enterprise: {
      ...
      extensionAllowlist: clampLines(raw.enterprise?.extensionAllowlist, 200, 300),
      blockUnlistedExtensions: bool(raw.enterprise?.blockUnlistedExtensions, d.enterprise.blockUnlistedExtensions),
      disablePrinting: bool(raw.enterprise?.disablePrinting, d.enterprise.disablePrinting),
      disableClipboardRead: bool(raw.enterprise?.disableClipboardRead, d.enterprise.disableClipboardRead),
      disableScreenCapture: bool(raw.enterprise?.disableScreenCapture, d.enterprise.disableScreenCapture),
      disableDeveloperTools: bool(raw.enterprise?.disableDeveloperTools, d.enterprise.disableDeveloperTools),
      forceSiteIsolation: bool(raw.enterprise?.forceSiteIsolation, d.enterprise.forceSiteIsolation)
    },
    ...
    customFilterRules: typeof raw.customFilterRules === 'string' ? raw.customFilterRules.slice(0, 1000000) : '',
    enabledFilterLists: listStrings(raw.enabledFilterLists ?? d.enabledFilterLists,20,60),
    filterListAutoUpdate: bool(raw.filterListAutoUpdate,d.filterListAutoUpdate),
