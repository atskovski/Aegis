...
if(Number(M.manifest_version)>=3&&M.action)api.action=actionApi('action');
if(Number(M.manifest_version)===2&&M.browser_action){api.browserAction=actionApi('browserAction');delete api.browserAction.getUserSettings}
if(Number(M.manifest_version)===2&&M.page_action){api.pageAction=actionApi('pageAction');delete api.pageAction.getUserSettings}
