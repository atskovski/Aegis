...
const actionApi=(root)=>({setTitle:(d={},...r)=>call(root+'.setTitle',d||{},...r),getTitle:(d={},...r)=>call(root+'.getTitle',d||{},...r),setBadgeText:(d={},...r)=>call(root+'.setBadgeText',d||{},...r),getBadgeText:(d={},...r)=>call(root+'.getBadgeText',d||{},...r),setBadgeBackgroundColor:(d={},...r)=>call(root+'.setBadgeBackgroundColor',d||{},...r),setPopup:(d={},...r)=>call(root+'.setPopup',d||{},...r),getPopup:(d={},...r)=>call(root+'.getPopup',d||{},...r),setIcon:(d={},...r)=>call(root+'.setIcon',d||{},...r),enable:(...a)=>call(root+'.enable',...a),disable:(...a)=>call(root+'.disable',...a),isEnabled:(...a)=>call(root+'.isEnabled',...a),openPopup:(...a)=>call(root+'.openPopup',...a),onClicked:event(root+'.onClicked')});
...
const webRequest={onBeforeRequest:event('webRequest.onBeforeRequest'),onBeforeSendHeaders:event('webRequest.onBeforeSendHeaders'),onSendHeaders:event('webRequest.onSendHeaders'),onHeadersReceived:event('webRequest.onHeadersReceived'),onResponseStarted:event('webRequest.onResponseStarted'),onCompleted:event('webRequest.onCompleted'),onErrorOccurred:event('webRequest.onErrorOccurred')};
...
i18n:{getUILanguage:()=> 'en-US',getMessage:(key,subs)=>{let t=String(MSG[String(key||'')]||'');const a=Array.isArray(subs)?subs:[subs];a.filter(x=>x!==undefined).forEach((v,i)=>{t=t.split('
...
scripting:{executeScript:(...a)=>call('scripting.executeScript',...a),insertCSS:(...a)=>call('scripting.insertCSS',...a),removeCSS:(...a)=>call('scripting.removeCSS',...a)},
