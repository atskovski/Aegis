...
const allowedInvoke = new Set(['state:get','settings:get','network:test','network:test-tor','security-suite:run','security-test:open','enterprise:import-policy','enterprise:export-events','extensions:list','extensions:install','extensions:set-enabled','extensions:remove']);
