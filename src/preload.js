...
const allowedInvoke = new Set(['state:get','settings:get','network:test','network:test-tor','security-suite:run','extensions:list','extensions:install','extensions:set-enabled','extensions:remove']);
