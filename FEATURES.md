# Aegis v0.8 Privacy & Safety Feature Matrix

| Inspiration / capability | Native Aegis implementation | Scope / limitation |
|---|---|---|
| uBlock Origin | Main-process network blocking for ads, known trackers, social pixels, cryptominers, fingerprint endpoints + bounded hostname block/allow rules | No cosmetic-filter engine, procedural filters or uBO scriptlet ecosystem in v0.5 |
...
## v0.8 Verification & control layer
- Security Suite with explicit PASS / FAIL / NOT TESTED evidence.
